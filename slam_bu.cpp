...
// g++ -fast ./slim.cpp -L/usr/local/lib -I/usr/local/include -lgsl -lgslcblas -o slim // Mac mini
//
...
// 05/19/2014: Mutations are now introduced in linkage equilibrium, rather than in linkage disequilibrium. This concerns the method introduce_mutation() of the class 'population'.
// 08/19/2014: Changed from multiplicative to additive fitness interactions among loci. This concerns the method W() of the class 'subpopulation'.
// xx/xx/2014: Added the possibility to define habitat specific fitnesses. To this purpose, the
    ...
    // habitat.
// xx/xx/2014: Introduced a switch that allows the user to choose whether mutations introduced at
    // a given point in time should initially be in linkage disequilibrium (as it was originally
    // the case in SLiM) or at linkage equilibrium (new).
